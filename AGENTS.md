...
Phases 1–5 are complete (section 0.1); Phase 6 is next. The Architecture v1.5 deletion/anonymization documentation (section 0.3, section 18) is a separate contract correction for future Phase 5 work — it is not part of the Phase 1–2 milestones above.
